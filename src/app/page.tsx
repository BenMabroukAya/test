  ...
  return (
    <div>
      ...
      <main>
        ...
        <center><h2>Rôle de l'énergie Solaire</h2>
        <p>
        ...
        <center><h2>Types de l'énergie Solaire</h2></center>
        <p>
          <ul>

            <li>Energie thermique :</li> < br />
            L’énergie solaire thermique est une technologie qui consiste à capter les rayons solaires pour 
            produire de la chaleur ou de l’eau chaude.< br />

            < br /><li>Energie thermique</li>< br />
        ...
        <center><h2>Où se trouve l'énergie solaire?</h2>
        <p>L'énergie solaire est utilisée essentiellement pour deux usages : la production d'électricité (énergie 
          solaire photovoltaïque ou énergie solaire thermodynamique) ou la production de chaleur (énergie solaire thermique).</p></center>
      </main>
    </div>
  );
};
